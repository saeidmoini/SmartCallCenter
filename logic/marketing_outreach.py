...
class MarketingScenario(BaseScenario):
    ...
    async def _detect_intent(self, transcript: str) -> str:
        ...
        yes_tokens = {
            ...
            "والا الان الانم پشت فرمونم اگر لینک چیزی هست برام ارسال کنید بعدا ببینم",
            "فرانسه و آلمانی رو می‌خوام بدونم فضای مختلفی داشت",
            "کدوم آموزشگاه هستید",
            "راهنمایی کنید",
            "حضور اگه بخوام کجا هستید شما",
            "زنده باشید تماس گرفتم ببینم کجا هست چطوریه کلاس‌های",
        }
        no_tokens = {
